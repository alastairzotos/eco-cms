...
import { beginGetFilesAndFolders, setCurrentPath, setFilesViewStyle } from '~/modules/admin/actions';
import {
    getCurrentPath,
    getFilesAndFoldersFetchStatus,
    getFilesViewStyle
} from '~/modules/admin/selectors/files';
import { getUpperPath } from '~/modules/admin/utils/files';
